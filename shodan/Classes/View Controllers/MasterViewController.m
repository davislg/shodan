...
-(void)queryAPI{
	...
	NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
	self.telnet = [telnet intValue] ? NSLocalizedString(@"True", @"Translation of true") : NSLocalizedString(@"False", @"Translation of false");
	[defaults setObject:telnet forKey:kTelnet];
	
	self.https = [https intValue] ? NSLocalizedString(@"True", @"Translation of true") : NSLocalizedString(@"False", @"Translation of false");
	[defaults setObject:https forKey:kHttps];
	
	self.unlocked = [unlocked intValue] ? NSLocalizedString(@"True", @"Translation of true") : NSLocalizedString(@"False", @"Translation of false");
	[defaults setObject:unlocked forKey:kUnlocked];
	
	self.plan = (plan) ? NSLocalizedString(plan, @"The plan") : NSLocalizedString(@"Invalid API", @"The plan");
